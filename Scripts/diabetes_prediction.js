...
function validateForm() {
    ...
    if (isNaN(diabetesPedigreeFunction) || diabetesPedigreeFunction < 0) {
      formValid = false;
    ...
    if (glucose < 20) {
      formValid = false;
      errorMessages += "⚠️ The minimum required glucose level is 20.\n";
    } else if (glucose < 70) {
      formValid = false;
      errorMessages += "⚠️ The glucose level is below the recommended value of 70.\n";
    } else if (glucose > 300) {
      formValid = false;
      errorMessages += "⚠️ The glucose level is too high. Maximum limit is 300.\n";
    }
